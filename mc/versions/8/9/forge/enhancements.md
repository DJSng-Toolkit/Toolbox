...
| --- | :---: | :---: | :---: | :---: |
| [Canelex Keystrokes Revamp](https://modrinth.com/mod/keystrokes) | Unknown | A revamp of the original Keystrokes mod from Canelex | Client | N/A |
| [ColorSaturation](https://modrinth.com/mod/colorsaturation) | Unknown | Simple color saturation mod for 1.8.9 | Client | N/A |
...
| [PolyHitbox](https://modrinth.com/mod/hitbox) | Unknown | An extremely customizable hitbox mod | Client | N/A |
| [PolyNametag](https://modrinth.com/mod/polynametag) | Unknown | An extremely customizable nametag mod | Client | N/A |
| [PolySprint](https://modrinth.com/mod/polysprint) | Unknown | Toggle sprint and sneak mod for Minecraft 1.8.9 and 1.12.2. | Client | N/A |
| [VanillaHUD](https://modrinth.com/mod/vanillahud) | Unknown | A mod that modifies various vanilla HUD elements, such as the bossbar, action bar, and sidebar. | Client | N/A |
...
| [SkyClientCosmetics](https://modrinth.com/mod/scc) | Unknown | Cosmetics and visual customization mod for SkyClient | Client | Intended for use on SkyClient, btu can also be installed on regular configs. |
